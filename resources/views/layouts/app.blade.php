  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{URL::route('Get.Student.List')}}"><i class="fa fa-circle-o"></i>List Students</a></li>
                <li><a href="{{URL::route('Get.Student.Search')}}"><i class="fa fa-circle-o"></i>Add Students</a></li>
              </ul>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong> <a href="http://almsaeedstudio.com"></a>.</strong> All rights reserved.
      </footer>
